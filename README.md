...
Данные структурированы, логичны, полностью соответствуют установленным критериям и пригодны для последующей обработки в экосистеме Hadoop и Spark.
...
Результаты первого тестового запуска можете увидеть на скринах ниже (в репозитории сохранен результат второго тестового запуска):
...
**.repartition(4):** контроль параллелизма. Исходный DataFrame может быть прочитан в 1–2 партиции
Увеличим число партиций, так будет лучше распараллеливание.  
